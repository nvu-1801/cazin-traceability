...
export default function ProductInfo() {
  return (
    <section
      className="w-full px-5 py-6 md:py-10 animate-fade-in-up"
        ...
        <div className="mb-8">
          ...
          <div className="mb-8">
            <p className="text-textMain font-normal not-italic text-base md:text-[17px] leading-relaxed text-justify mb-3">
              Trà tía tô túi lọc CAZIN là sự kết tinh từ nguồn dược liệu tuyển
              chọn tại Gia Lai, kết hợp hài hòa giữa tía tô, sả và gừng, mang
              hương thơm thanh dịu và vị ấm tự nhiên đặc trưng. Được chế biến từ
              100% nguyên liệu tự nhiên, không hương liệu, không chất bảo quản,
              sản phẩm mang đến trải nghiệm thưởng trà tiện lợi và chất lượng.
            </p>
            <p className="text-textMain font-normal not-italic text-base md:text-[17px] leading-relaxed text-justify">
              Mỗi tách trà không chỉ lưu giữ tinh túy của thảo mộc Việt, mà còn
              gửi gắm giá trị của vùng đất Gia Lai và mang tinh hoa trà thảo mộc
              Gia Lai đến với người tiêu dùng.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-textMain text-base">
              Tía tô 80% (thân và lá), Sả 10%, Gừng 10%.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 bg-white/50 p-6 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-white/50">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-textMain text-[15px] font-normal">
                12 tháng
              </span>
            </div>
            ...
            <div className="col-span-2 md:col-span-3 flex flex-col pt-2 border-t border-primary/10">
              ...
              <span className="text-textMain text-[15px] font-normal">
                Túi lọc giấy; hộp giấy cứng đảm bảo an toàn dùng trong thực
                phẩm.
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col space-y-8 mt-10">
          ...
          <div>
            ...
            <p className="text-textMain text-[15px] leading-relaxed">
              Tía tô, sả và gừng được thu mua từ các vùng nguyên liệu tại Canh
              Vinh, An Khê và các vùng lân cận thuộc tỉnh Gia Lai.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-none p-0 m-0 space-y-2">
              <li className="text-textMain text-[15px]">
          ...
          <div>
            ...
            <div className="space-y-3">
              <p className="text-textMain text-[15px]">
                Dùng 1 túi trà 2g cho mỗi lần pha.
              </p>

              <div>
                <p className="text-textMain text-[15px] font-semibold mb-1">
                  Uống nóng
                </p>
                <p className="text-textMain text-[15px]">
                  Ngâm 01 túi trà với 120ml nước nóng trong 5 phút.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-textMain text-[15px]">
                  Ngâm 01 túi trà với 90ml nước nóng trong 5 phút, thêm đá tùy
                  khẩu vị.
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {/* Phần Bảo quản */}
              <p className="text-textMain text-[15px]">
                <span className="font-semibold">Bảo quản:</span> Để nơi khô ráo,
                thoáng mát.
              </p>

              {/* Phần Khuyến cáo thiết kế lại với dạng list */}
              <div className="text-textMain text-[15px]">
                <span className="font-semibold">Khuyến cáo:</span>
                <ul className="list-disc pl-5 mt-1 space-y-1">
                  <li>
                    Không sử dụng khi sản phẩm có dấu hiệu ẩm mốc, biến màu hoặc
                    có mùi lạ.
                  </li>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-textMain text-[15px]">
                <span className="font-semibold">Ngày sản xuất:</span> Xem trên
                bao bì
              </p>
              <p className="text-textMain text-[15px]">
                <span className="font-semibold">Số bản tự công bố:</span>{" "}
                03/NCD/2023
              </p>
              <p className="text-textMain text-[15px]">
                <span className="font-semibold">TCCS:</span> 04:2023
              </p>
              <p className="text-textMain text-[15px]">
