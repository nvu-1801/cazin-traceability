...
export default function Certificates() {
  return (
    <section className="w-full px-5 py-8 md:py-12 bg-background border-t border-cream">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold text-primary mb-8 inline-flex items-center gap-3">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-8 w-full">
          {certImages.map((cert, index) => (
            ...
            >
              {/* Tiêu đề đóng khung */}
              <div className="w-full bg-primary/5 text-primary font-bold uppercase text-center py-4 px-4 text-sm md:text-base border-b border-primary/10 break-words flex items-center justify-center min-h-[4rem]">
                {cert.title}
              </div>
